...
export default class FolderComponent extends Component {
    ...
    handleRefresh = () => {
        this.setState(
            ...
            () => {
                this.props.parentView._getAll(this.props.data, this);
            }
        );
    };
    ...
    renderItem({ item }) {
        return (
            <TouchableOpacity activeOpacity={0.8} onPress={() => this.props.parentView.detail()}>
        ...
        return (
            <Container style={{ backgroundColor: AppCommon.background_color }}>
                ...
                >
                    ...
                    <Body style={{ flex: 1 }}>
                        <Title style={{ alignSelf: "center", color: 'white' }}>{this.props.title}</Title>
                    </Body>
                    <TouchableOpacity style={styles.menuButton} onPress={() => null} >
