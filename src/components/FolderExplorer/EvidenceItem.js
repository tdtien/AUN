                ...
                <View style={styles.item}>
                    <View style={styles.leftItem}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'column' }}>
                            <Text style={{ color: 'black', paddingHorizontal: 20, fontSize: 20 }} numberOfLines={3}>{this.props.item.content}</Text>
                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                <Text style={{ color: 'gray', paddingLeft: 20, fontSize: 15 }}>{moment(this.props.item.createdAt).format('DD/MM/YYYY')}</Text>
                            </View>
                        </View>
                    </View>
